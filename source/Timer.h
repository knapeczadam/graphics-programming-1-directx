...
namespace dae
{
    ...
    public:
        ...
        inline float    GetdFPS()    const { return m_dFPS;        }
        inline float    GetElapsed() const { return m_ElapsedTime; }
        inline float    GetTotal()   const { return m_TotalTime;   }
        inline bool     IsRunning()  const { return !m_IsStopped;  }
